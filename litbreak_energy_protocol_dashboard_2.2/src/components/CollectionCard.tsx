      ...
      <div className="p-4">
        ...
        <div className="grid grid-cols-2 gap-2">
          <div>
            ...
            <div className="text-xs font-mono font-semibold text-white">{collection.floorPrice} LTC</div>
          </div>
          <div>
          ...
          <div>
            ...
            <div className="text-xs font-mono text-white">{collection.items.toLocaleString()}</div>
          </div>
          <div>
            <div className="text-[10px] text-textSecondary">Owners</div>
            <div className="text-xs font-mono text-white">{collection.owners.toLocaleString()}</div>
          </div>
        </div>
      </div>
    </motion.div>
