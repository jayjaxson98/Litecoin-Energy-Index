...
import type { Agent, AgentRiskLevel, AgentStatus } from '../types/utx';
...
const riskColors: Record<AgentRiskLevel, string> = {
  ...
  return (
    ...
    >
      <div className="flex items-start justify-between mb-3">
        ...
        <span
          className={`px-2 py-0.5 rounded-full text-[10px] font-semibold border ${riskColors[agent.riskLevel]}`}
        >
      ...
      <div className="grid grid-cols-2 gap-3 mt-4">
        <div className="flex items-center gap-1.5">
          ...
          <span className="text-xs font-mono font-semibold text-success ml-auto">
        ...
        <div className="flex items-center gap-1.5">
          ...
          <span className="text-xs font-mono font-semibold text-white ml-auto">
        ...
        <div className="flex items-center gap-1.5">
          ...
          <span className={`text-xs font-semibold ml-auto capitalize ${statusColors[agent.status]}`}>
            {agent.status}
          </span>
        </div>
      </div>
