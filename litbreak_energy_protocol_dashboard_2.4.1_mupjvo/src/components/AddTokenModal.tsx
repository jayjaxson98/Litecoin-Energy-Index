            ...
            >
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="text-xs text-textSecondary font-mono">
                          {foundToken.symbol} · {foundToken.decimals} decimals
                        </div>
                      </div>
                    </div>
                  ...
                  >
                    ...
                    <div>
                      ...
                      <div className="text-xs text-textSecondary">
                        {foundToken.name} ({foundToken.symbol}) imported successfully
                      </div>
                    </div>
                  </motion.div>
                )}
              ...
              <div className="px-5 pb-5">
                <p className="text-[10px] text-textSecondary/60 text-center leading-relaxed">
                  Only add tokens you trust. Verify the contract address on the block explorer before
                  importing.
                </p>
              </div>
            </div>
